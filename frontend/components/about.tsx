        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-8">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-[1.15]">
            {language === 'en' ? (
              ...
              <>
                <span className="text-[#8E8EA0]">Memberdayakan </span>
                <span className="text-[#FFFFFF]">Bisnis Lokal </span>
                <br className="hidden md:block" />
                <span className="text-[#8E8EA0]">Melalui </span>
                <span className="text-[#FFFFFF]">Transformasi Digital </span>
                <span className="text-[#8E8EA0]">Instan.</span>
              </>
            )}
          </h2>
          ...
          <p className="text-base sm:text-lg text-[#8E8EA0] max-w-2xl mx-auto font-medium">
            {language === 'en' 
              ...
              : 'Growfin Digital mendemokratisasi teknologi kelas atas. Baik Anda membutuhkan template website siap pakai dalam 24 jam atau aplikasi berskala besar yang kustom, kami adalah mitra pertumbuhan jangka panjang Anda.'}
          </p>
